...
async function createDatabase() {
    try {
        ...
        console.log("\x1b[32mMovies inserted successfully.\x1b[0m");
    } catch (error) {
        console.log("\x1b[31mError occurred: \x1b[0m", error);
    } finally {
        mongoose.disconnect();
    }
    console.log("\x1b[36mDatabase 'DB-Milton' has been created. Please run main.js to access the application.\x1b[0m");
}
